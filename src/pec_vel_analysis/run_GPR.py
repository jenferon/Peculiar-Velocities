...
fits.writeto(base + 'residuals_fg_GPR_140_180_LC_1024.fits', resids_GPR, overwrite=True)
fits.writeto(base + 'residuals_fg_GPR_140_160_LC_1024.fits', resids_GPR_1, overwrite=True)
fits.writeto(base + 'residuals_fg_GPR_150_170_LC_1024.fits', resids_GPR_2, overwrite=True)
fits.writeto(base + 'residuals_fg_GPR_160_180_LC_1024.fits', resids_GPR_3, overwrite=True)
